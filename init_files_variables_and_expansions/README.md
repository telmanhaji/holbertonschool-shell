#This is readme file explains all tasks in project "Shell, init files, variables and expansions".
1. 0-alias - script that creates an alias.
2. 1-hello_you - script that prints hello user, where user is the current Linux user.
3. 2-path - adding /action to the PATH. /action should be the last directory the shell looks into when looking for a program.
